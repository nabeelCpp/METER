<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        <a href="{{ route('superadmin.dashboard') }}" class="navbar-brand mx-4 mb-3">
            <h3 class="text-primary">{!! site_logo() !!}</h3>
        </a>
        <div class="d-flex align-items-center ms-4 mb-4">
            ...
            <div class="ms-3">
                <!-- Dynamically display the Super Admin's name -->
                <h6 class="mb-0">{{ auth()->guard('superadmin')->user()->name }}</h6>
                <span>Super Admin</span>
            </div>
        </div>
        <div class="navbar-nav w-100">
            <a href="{{ route('superadmin.dashboard') }}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
            <a href="#" class="nav-item nav-link"><i class="fa fa-users me-2"></i>Manage Admins</a>
